...
$id = $_GET['id'];
$sqllivro = mysqli_query($conn, "SELECT * FROM livros WHERE idLivro = '$id'");
$row = mysqli_fetch_assoc($sqllivro);
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>EEEPBooks Dashboard - Categoria</title>
...
<body>
                        ...
                        <form action="">
                            ...
                            <label class="block text-sm">
                                ...
                                <input
                                    ...
                                    placeholder="Harry Potter..." name="titulo" value="<?php echo $row['titulo']; ?>" />
                            </label>
                            <br>
                            <label class="block text-sm">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-red-400 focus:outline-none focus:shadow-outline-red dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                    placeholder="Sinopse......" name="sinopse" value="<?php echo $row['sinopse']; ?>" />
                            </label>
                            <br>
                            <label class="block text-sm">
    ...
    <script src="../../assets/js/editlivro.js"></script>
