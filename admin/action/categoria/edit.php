<?php
  ...
  $sqlselect = mysqli_query($conn, "SELECT * FROM categoria WHERE idCategoria = '$idCategoria'");
...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  ...
  <body>
    ...
    >
      ...
      <div class="flex flex-col flex-1">
        ...
        <div class="container px-6 mx-auto grid">
            ...
            >
              Editar Categoria: "<?php echo $row['titulo'] ?>"
            </h2>
            <!-- CTA -->
            ...
            <div class="errortxt"></div>
              ...
              <input name='id' value='<?php echo $idCategoria?>' hidden/>
                <br>
                <button
    ...
    <script src="../../assets/js/editca.js"></script>
